...
#define TUYA_DEVICE_PID         "pxxyuph4" //pxxyuph4, 
...
#define TUYA_DEVICE_FVER_NUM    0x00000002                                  //固件版本
#define TUYA_DEVICE_HVER_NUM    0x00000100                                  //硬件版本
#define TUYA_DEVICE_FVER_STR    "0.2"                                       //固件版本str
...
typedef enum
{
    ...
    APP_EVT_OPEN_WITH_MASTER_RECORD,
    APP_EVT_TIMER_0,
    APP_EVT_TIMER_1,
    APP_EVT_TIMER_2,
    APP_EVT_TIMER_3,
